...
public class Router2 extends Node {
    ...
    static final int SRC_PORT = 50008;          //port number of this router
    ...
    private void initialiseHashmap() {
        // Dest port | next hop
        flowTable.put(new Integer(50009), new Integer(50009));
    }
}
